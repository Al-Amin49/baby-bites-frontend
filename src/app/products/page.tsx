...
const ProductsPage=async()=>{
    ...
    return (
        <Container className="my-10" >
           <h3 className="text-center my-4 text-secondary font-bold">All Products</h3>
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
        <div className="" >
            <div>
            <h3 className="text-secondary font-bold text-xl my-4">Price Range</h3>
            ...
            <div>
            <h3 className="text-secondary font-bold text-xl my-4">Categories</h3>
            </div>
            <div>
            ...
            <div className="card-body">
              ...
              <p>{sale.flashSale ?  <>
                ...
                <span className="font-bold ml-2">${sale.salePrice}</span>
                    </> :<span className=" text-gray">${sale.price} </span>}</p>
              </div>
            </div>
          </div>
          </Link>
